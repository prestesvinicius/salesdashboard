...
# Objetivo criar um dashboard de vendas no Python que responda as seguintes perguntas
# Faturamento mensal por unidade
# Desempenho mensal das formas de pagamento
# Avaliação mensal de cada filial

st.set_page_config(layout="wide")

df = pd.read_csv("C:\\Users\\prest\\Documents\\Dashboard_python\\supermarket_sales.csv", sep=";", decimal=",")
